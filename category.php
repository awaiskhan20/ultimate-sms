...
<head>
    ...
    <meta content="Al-Fateem is the best academy of Web Developement" name="description" />
    <meta content="Ayaz Ahmed Mast" name="author" />
                ...
                <div class="grid-body no-border">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="add_category.html" class="btn btn-primary tip" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_category.html" class="label label-info"> <i class="fa fa-edit"></i></a>
